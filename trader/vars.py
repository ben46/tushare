...
NEWSTK_LIST_COLS = ['issuetype', 'stkname', 'buyunit', 'secuid', 'stkcode', 'issuedate', 'market', 'marketName', 'issuetypeName', 'maxqty', 'linkstk','fixprice','minqty']
