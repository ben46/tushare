...
KLINE_USTT_COLS = ['date', 'open', 'close', 'high', 'low', 'volume', 'jjj']
KLINE_HKTT_COLS = ['date', 'open', 'close', 'high', 'low', 'volume', 'key7', 'key8', 'key9']
...
TOKEN_F_P = 'tk.csv'
CACHE_DIR = '/Users/nobbyheell/Documents/workspace/migungun_desktop/tushare/cache/'
